  ...
  */
    ...
    */
			...
			value: function _initDateDialog(m) {
				...
				this._fillText(titleDay, m.format('dddd'));
				this._fillText(titleMonth, m.format('D MMMM'));
				this._initYear();
			...
			value: function _addCellClickEvent(el) {
				...
				el.onclick = function (e) {
					if (e.target && e.target.nodeName == 'SPAN' && e.target.classList.contains('mddtp-picker__cell')) {
						...
						me._fillText(titleDay, currentDate.format('dddd'));
						me._fillText(titleMonth, currentDate.format('D MMMM'));

                        ...
                        <form action="#" class="form-horizontal form-label-left" name="store" id="store">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label for="id_academic_period" id="id_academic_period_label">Periódo Académico</label>

                                        <input type="text" name="id_academic_period_txt" id="id_academic_period_txt" value="" style="display:none" class="form-control" placeholder="dd-mm-yyyy" />
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label for="num_tel_mobile">Como se entero del Curso-Diploma</label>

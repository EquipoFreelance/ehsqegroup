        ...
        <div class="left_col scroll-view md">
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="{{ ( Auth::user()->avatar == '')?  URL::asset( 'assets/images/users/user.png' ) :  URL::asset( Auth::user()->avatar ) }}" alt="{{ Auth::user()->fullname }}" class="img-circle profile_img">
            </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="{{ ( Auth::user()->avatar == '')?  URL::asset( 'assets/images/users/user.png' ) :  URL::asset( Auth::user()->avatar ) }}" alt="">{{ Auth::user()->fullname }}
